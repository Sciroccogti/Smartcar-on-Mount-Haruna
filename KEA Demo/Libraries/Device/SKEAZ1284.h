...
**                          SKEAZ1284.h, Rev. 1.3, Dec 2014-05-28, Build b140528
**                          SKEAZ1284.h, Rev. 1.3, Dec 2014-06-18, Build b140623
**     Version:             rev. 1.0, 2018-05-05
**     Build:               xhjiang
**	   
**
**     Abstract:            CMSIS Peripheral Access Layer for SKEAZ1284.
**
**
...
#if !defined(SKEAZ1284_H_)	 /*	Another prevention same to the former one */
...
typedef enum {
  ...
  INT_Watchdog                 = 44,               /**< Watchdog timeout */
...
#define ACMP0_BASE_PTR                           ((ACMP_MemMapPtr)ACMP0_BASE)
#define ACMP0                                    (ACMP0_BASE_PTR)
/** Peripheral ACMP1 base address */
#define ACMP1_BASE                               (0x40074000u)
/** Peripheral ACMP1 base pointer */
#define ACMP1_BASE_PTR                           ((ACMP_MemMapPtr)ACMP1_BASE)
#define ACMP1                                    (ACMP1_BASE_PTR)
...
#define ADC_BASE_PTR                             ((ADC_MemMapPtr)ADC_BASE)
...
#define CRC_BASE_PTR                             ((CRC_MemMapPtr)CRC_BASE)
#define CRC0                                     (CRC_BASE_PTR)
...
#define FTM0_BASE_PTR                            ((FTM_MemMapPtr)FTM0_BASE)
#define FTM0                                     (FTM0_BASE_PTR)
/** Peripheral FTM1 base address */
#define FTM1_BASE                                (0x40039000u)
/** Peripheral FTM1 base pointer */
#define FTM1_BASE_PTR                            ((FTM_MemMapPtr)FTM1_BASE)
#define FTM1                                     (FTM1_BASE_PTR)
/** Peripheral FTM2 base address */
#define FTM2_BASE                                (0x4003A000u)
/** Peripheral FTM2 base pointer */
#define FTM2_BASE_PTR                            ((FTM_MemMapPtr)FTM2_BASE)
...
#define FTMRE_BASE_PTR                           ((FTMRE_MemMapPtr)FTMRE_BASE)
#define FTMRE                                    (FTMRE_BASE_PTR)
...
#define GPIOA_BASE_PTR                           ((GPIO_MemMapPtr)GPIOA_BASE)
#define GPIOA                                    (GPIOA_BASE_PTR)
/** Peripheral GPIOB base address */
#define GPIOB_BASE                               (0x400FF040u)
/** Peripheral GPIOB base pointer */
#define GPIOB_BASE_PTR                           ((GPIO_MemMapPtr)GPIOB_BASE)
#define GPIOB                                    (GPIOB_BASE_PTR)
/** Peripheral GPIOC base address */
#define GPIOC_BASE                               (0x400FF080u)
/** Peripheral GPIOC base pointer */
#define GPIOC_BASE_PTR                           ((GPIO_MemMapPtr)GPIOC_BASE)
#define GPIOC                                    (GPIOC_BASE_PTR)
...
#define I2C0_BASE_PTR                            ((I2C_MemMapPtr)I2C0_BASE)
#define I2C0                                     (I2C0_BASE_PTR)
/** Peripheral I2C1 base address */
#define I2C1_BASE                                (0x40067000u)
/** Peripheral I2C1 base pointer */
#define I2C1_BASE_PTR                            ((I2C_MemMapPtr)I2C1_BASE)
...
#define ICS_BASE_PTR                             ((ICS_MemMapPtr)ICS_BASE)
#define ICS                                      (ICS_BASE_PTR)
...
#define IRQ_BASE_PTR                             ((IRQ_MemMapPtr)IRQ_BASE)
#define IRQ                                      (IRQ_BASE_PTR)
...
#define KBI0_BASE_PTR                            ((KBI_MemMapPtr)KBI0_BASE)
#define KBI0                                     (KBI0_BASE_PTR)
/** Peripheral KBI1 base address */
#define KBI1_BASE                                (0x4007A000u)
/** Peripheral KBI1 base pointer */
#define KBI1_BASE_PTR                            ((KBI_MemMapPtr)KBI1_BASE)
#define KBI1                                     (KBI1_BASE_PTR)
...
#define MCM_BASE_PTR                             ((MCM_MemMapPtr)MCM_BASE)
...
#define MSCAN_BASE_PTR                           ((MSCAN_MemMapPtr)MSCAN_BASE)
#define MSCAN                                    (MSCAN_BASE_PTR)
...
#define FTMRE_FlashConfig                        (FTMRE_FlashConfig_BASE_PTR)
...
#define PMC_BASE_PTR                             ((PMC_MemMapPtr)PMC_BASE)
...
#define PORT_BASE_PTR                            ((PORT_MemMapPtr)PORT_BASE)
#define PORT                                     (PORT_BASE_PTR)
...
#define PWT_BASE_PTR                             ((PWT_MemMapPtr)PWT_BASE)
#define PWT                                      (PWT_BASE_PTR)
...
#define ROM_BASE_PTR                             ((ROM_MemMapPtr)ROM_BASE)
#define ROM                                      (ROM_BASE_PTR)
...
#define RTC_BASE_PTR                             ((RTC_MemMapPtr)RTC_BASE)
...
#define SIM_BASE_PTR                             ((SIM_MemMapPtr)SIM_BASE)
...
#define SPI0_BASE_PTR                            ((SPI_MemMapPtr)SPI0_BASE)
#define SPI0                                     (SPI0_BASE_PTR)
/** Peripheral SPI1 base address */
#define SPI1_BASE                                (0x40077000u)
/** Peripheral SPI1 base pointer */
#define SPI1_BASE_PTR                            ((SPI_MemMapPtr)SPI1_BASE)
...
#define UART0_BASE_PTR                           ((UART_MemMapPtr)UART0_BASE)
#define UART0                                    (UART0_BASE_PTR)
/** Peripheral UART1 base address */
#define UART1_BASE                               (0x4006B000u)
/** Peripheral UART1 base pointer */
#define UART1_BASE_PTR                           ((UART_MemMapPtr)UART1_BASE)
#define UART1                                    (UART1_BASE_PTR)
/** Peripheral UART2 base address */
#define UART2_BASE                               (0x4006C000u)
/** Peripheral UART2 base pointer */
#define UART2_BASE_PTR                           ((UART_MemMapPtr)UART2_BASE)
...
#define WDOG_BASE_PTR                            ((WDOG_MemMapPtr)WDOG_BASE)
